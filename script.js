...
document.getElementById('customerForm').addEventListener('submit', function (e) {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbyJHFenBd7qygcRvZqr8dmXOYFFKFCEZMRSRwXr9T3Ocz1cKMg7hZ1jcWgbHySod69zdw/exec';  // Reemplaza con tu URL de Web App
    ...
    fetch(scriptURL, { method: 'POST', body: formData })
        ...
        .then(responseText => {
            ...
            const whatsappNumber = '573122977409';  // Reemplaza con el número de WhatsApp en formato internacional, sin el "+"
